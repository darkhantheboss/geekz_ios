...
class ExtensionsTableViewController: UITableViewController, ScriptEditorDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Готово", style: .done, target: self, action: #selector(self.done(sender:)))
...
//        }
	...
	@objc func promptForScriptName() {
		...
		av.addAction(UIAlertAction(title: "Отмена", style: .cancel, handler: nil))
