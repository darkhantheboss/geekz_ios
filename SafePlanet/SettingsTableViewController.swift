...
enum DeleteSectionTitles: String {
    case clearHistory = "Очистить историю"
    case clearCookies = "Очистить локальные данные"
...
class SettingsTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        title = "Настройки"
        self.navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Готово", style: .done, target: self, action: #selector(done))
